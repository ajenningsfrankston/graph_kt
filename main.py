...
def main():
    ...
    arg_parser.add_argument('--att_bound', type=float, default=0.5)  # filtering irralate emb in topk selection
    arg_parser.add_argument('--sim_emb', type=str, default='skill_emb')  # filtering irralate emb in topk selection
